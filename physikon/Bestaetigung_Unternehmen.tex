...
\begin{itemize}
  \item \textbf{Messestand:} Sie erhalten eine Ausstellungsfläche von ca. 2,5 m x 2,5 m.
    ...
    Für eine ausreichende Stromversorgung (Watt??), sowie einen Internetzugang wird gesorgt.
    ...
    \end{itemize}
    Weiterhin benötigen wir einen kurzen Text (max. 700 Zeichen), der Ihr Unternehmen gut beschreibt, und ein Anzeigenbild (Format DIN A4 oder A5), das auf der Doppelseite erscheinen soll.
