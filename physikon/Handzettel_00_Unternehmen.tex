...
\begin{description}
  ...
  \item[\textbf{Stellenmarkt:}] Sollten Sie auf dem Stellenmarkt  offene Stellen, Praktika oder Traineeprogramme veröffentlichen wollen, schicken Sie und die Anzeigen bitte bis zum {\stellenanzeigen} zu.
\end{description}
