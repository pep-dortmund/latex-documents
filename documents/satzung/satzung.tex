...
\begin{enumerate}
	\item Der Verein \enquote{PeP et al.} arbeitet politisch unabhängig und ohne
...
\begin{enumerate}
	\item Die ordentliche und außerordentliche Mitgliedschaft im Verein endet
		...
		Kalenderjahres.
	\item Der Austritt aus dem Verein erfolgt durch schriftliche oder
    elektronische Mitteilung an den Vorstand.
...
\begin{enumerate}
	...
	\item Abweichend von § 32 Absatz 1 Satz 1 des Bürgerlichen Gesetzbuchs (BGB) kann
		der Vorstand nach seinem Ermessen beschließen und in der Einladung mitteilen, dass
		die Mitglieder an der Mitgliederversammlung ohne Anwesenheit an einem Versamm-
		lungsort teilnehmen und ihre Mitgliederrechte mittels elektronischer Kommunikation
		ausüben können oder müssen (Online-Mitgliederversammlung).
		Im Falle einer Online-Mitgliederversammlung werden die jeweils nur für die aktuelle Versammlung gültigen
		Zugangsdaten mit einer gesonderten Email unmittelbar vor der Versammlung, maximal 24 Stunden davor, bekannt gegeben.
		Die Mitglieder sind verpflichtet, die Zugangsdaten nicht an Dritte weiter zu geben.
		...
		Der Vorstand überprüft die Identität der teilnehmenden Mitglieder.
	...
	\item Über die Mitgliederversammlung und die in ihr getroffenen Beschlüsse
		...
		Versammlungsleiter/die Versammlungsleiterin und den Protokollführer/die Protokollführerin zu unterzeichnen ist.
		Dieses Protokoll ist allen Mitgliedern des Vereins \enquote{PeP et al.} in
	...
	\item Bei Abstimmung und Wahlen entscheidet die einfache Stimmenmehrheit
		...
		Im Falle der Stimmengleichheit bei Abstimmungen entscheidet der oder die Vorsitzende,
		bei Wahlen das Los.
...
\begin{enumerate}
	\item Der Vorstand im Sinne des §26 BGB besteht aus dem/der Vorsitzenden, dem/der
		stellvertretenden Vorsitzenden und dem Finanzreferenten oder der Finanzreferentin.\\
...
\begin{enumerate}
	...
	\item Bleiben Posten für Projektbeauftragte vakant, kann die
		...
		Kandidaten/eine geeignete Kandidatin zu finden und bis zur nächsten Mitgliederversammlung den Posten
	...
	\item Die Projektbeauftragten können durch die Mitgliederversammlung mit
		...
		Aufwendungen ausgestattet werden. In diesem Falle legt der/die
