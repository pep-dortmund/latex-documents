...
Nutzers. \todo[inline]{ist das korrekt?}
...
\todo[inline]{Ist der Satz überhaupt notwendig}
...
\todo[inline]{werden die Logfiles regelmäßig gelöscht?}
...
\todo[inline]{wie genau läuft das mit den cookies?}
...
\todo[inline]{müssen wir dann auch so eine Cookie-Meldung einrichten?}
...
verwiesen. \todo[inline]{Das müssen wir in jedem Anmeldeprozess Einholen!}
...
\todo[inline]{machen wir das bei Veranstaltungen?}
...
\todo[inline]{Was ist mit Daten in Protokollen?}
...
Rechtsgrundlage für die Verarbeitung der Daten ist bei Vorliegen einer
Einwilligung des Nutzers Art. 6 Abs. 1 lit. a DSGVO.
\todo[inline]{Wir müssen uns hier immer die Einwilligung einholen.}
...
\todo[inline]{Das könnte nervig für uns werden...}
...
\todo[inline]{Dienstleister können wir hier streichen, oder?}
...
Verarbeitung dieser Daten eingeholt und auf diese Datenschutzerklärung
verwiesen.
\todo[inline]{Für jede Anmeldung einrichten!}
...
Löschung.
\todo[inline]{Löschen wir das automatisch nach der Veranstaltung, oder wie läuft das aktuell?}
...
\todo[inline]{Können wir hier das Kontaktformular löschen?}
...
Datenschutzerklärung verwiesen.
\todo[inline]{Wir sollten auch überlegen, ob wir unsere Listen von Google umziehen wollen}
...
\todo[inline]{haben wir so einen Link?}

\todo[inline]{Nutzen wir irgendein Analysetool?}
...
\todo[inline]{Diesen Abschnitt könnte man evtl. rausnehmen}
