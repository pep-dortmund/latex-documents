...
\begin{center}
    ...
    \hfill%
    \includegraphics[height=1cm]{fakultaet.pdf}\\[.5cm]
...
\begin{center}
  \begin{tblr}{colsep=1em, rowspec={c l l} }
    \includegraphics[height=1.5cm, width=3cm]{example-image-a} & \includegraphics[height=1.5cm, width=3cm]{example-image-a} \\
